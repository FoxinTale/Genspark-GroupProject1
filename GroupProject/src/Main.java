...
public class Main {
    public static void main(String[] args) {
        ...
        String[] fileContent = readFile(filePath + "file3.txt");
    ...
    public static void handleArray(String[] content, int columns) {
        ...
        ArrayList<String> items = new ArrayList<>(Arrays.asList(content));
        ...
        System.out.println(items.subList(0, positions.get(1)));
